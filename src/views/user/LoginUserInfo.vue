<template>
  <div class="box-wrapper">
    ...
    <div class="content">
      <div class="box_input">
        <div class="imgs">
          <img src="@/assets/imgs/user/phone.png" alt />
        </div>
        <input
          type="tel"
          class="input"
          ...
          @change="handlephoneFlag()"
        />
      </div>
      <div class="box_input_code">
        <div class="left_code">
          <div class="imgs">
            <img src="@/assets/imgs/user/code.png" alt />
          </div>
          <input
            type="tel"
            id="input2"
      ...
      <div class="checkbox">
        ...
        <span class="agreement">
          <span @click="privacy(2)">《用户注册协议》</span>和
          <span @click="privacy(1)">《隐私政策》</span>
        </span>
      </div>
